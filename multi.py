# Logo
logo = """
\033[1;32m.______   .______        ______    __  ___  _______ .__   __.      _______ 
\033[1;32m|   _  \  |   _  \      /  __  \  |  |/  / |   ____||  \ |  |     /  _____|
\033[1;37m|  |_)  | |  |_)  |    |  |  |  | |  '  /  |  |__   |   \|  |    |  |  __  
\033[1;37m|   _  <  |      /     |  |  |  | |    <   |   __|  |  . `  |    |  | |_ | 
\033[1;32m|  |_)  | |  |\  \----.|  `--'  | |  .  \  |  |____ |  |\   |    |  |__| | 
\033[1;32m|______/  | _| `._____| \______/  |__|\__\ |_______||__| \__|     \______|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
╭───────────────────────── < YOUR INFO > ────────────────────────────────────╮
│ 【•】 YOUR IP       ➤ 117.96.144.37                                    │
│ 【•】 TODAY TIME    ➤ 06:33 PM                                            │
│ 【•】 TODAY DATE    ➤ 19/November/2024                                 │
╰───────────────────────────< YOUR INFO >────────────────────────────────────╯
╭───────────────────────── < ~ COUNTRY ~  > ──────────────────────────────────╮
│ 【•】 YOUR COUNTRY  ➤ INDIA                                        │
│ 【•】 YOUR REGION   ➤ BIHAR                                    │
...
<<══════════════════════════════════════════════════════════════════════════>>
[=] OWNER                     : BROKEN NADEEM                      [=]
[=] 𝐆𝐈𝐓𝐇𝐔𝐁                    : BROKEN NADEEM                      [=]
[=] 𝐑𝐔𝐋𝐄𝐗                     : COOKISE POST                       [=]
[=] 𝐅𝐀𝐂𝐄𝐁𝐎𝐊                   : PARDHAN KIING                      [=]
<<══════════════════════════════════════════════════════════════════════════>>
"""
print(logo)
...
def send_message(token, message, thread_id, haters_name):
    try:
        ...
        if message_response.status_code == 200:
            ...
            print(f"""
\033[1;32m
✪✭══════════•『 \033[1;32m \033[1;91m\033[1;41m\032[1;33m 𝗬𝗢𝗨𝗥 𝗦𝗠𝗦 𝗦𝗘𝗡𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗨𝗙𝗨𝗟 🎉\033[;0m\033[1;91m\033[1;92m\033[38;5;46m 』•══════════✭✪
""")
